        ...
        <div class="row">
            <div class="col col_1_3">
                <div class="inner">
                    ...
                    <h2 class="text-bold text-white">敏捷开发简单易用</h2>
                    <p>
                        Laravel是一个致力于优雅和简洁的PHP框架。编程不必须是痛苦的。事实上，Laravel是可以让你享受的工具。
                    </p>
                </div>
            </div>
            ...
            <div class="col col_1_3">
                <div class="inner">
                    ...
                    <h2 class="text-bold text-white">开源,并托管于GitHub</h2>
                    <p>Laravel使用MIT许可证发布,开发者可以更灵活的使用甚至在其基础上进行修改发布<a href="https://github.com/laravel/laravel" target="_blank" class="text-silver">https://github.com/laravel/laravel</a></p>
                </div>
            </div>
            ...
            <div class="col col_1_3">
                <div class="inner">
                    ...
                    <h2 class="text-bold text-white">文档丰富</h2>
                    <p>Laravel开发团队由Taylor Otwell带领,数百位的工程师参与,有完善的社区和文档,大大降低学习成本和开发成本</p>
                </div>
            </div>
        </div>
        <div class="clear"></div>
